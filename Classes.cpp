...
bool search_pass(string u, string p)
{
	fstream file_r;
	string user;
	string pass;
...
c:while (true)
{
	...
	bool p = false;
	p = search_pass(User_Name, Password);
	if (p == true)
	{
		system("cls");
		mainMenu();
...
void Add_Student::addStudent()
{
	...
	cout << "Your ID IS : 22L-" << std_number << endl;
	...
	write_File << "22L-" << std_number << endl;
